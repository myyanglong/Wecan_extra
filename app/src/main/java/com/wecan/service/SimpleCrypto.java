...
public class SimpleCrypto {
	...
	private static final String IV = "045872237367l998";
	private static final String AES = "AES"; 							// AES 加密
	private static final String CIPHERMODE = "AES/CBC/PKCS5Padding"; 	// algorithm/mode/padding
	private static final String HMACDATA = "aB45/CB%*LL5677@WECanadminlllljhhh344442df"; 	// algorithm/mode/padding
	...
	public static String hmacSha(String key) {
		String reString = "";
		try	{
			...
			byte[] text = HMACDATA.getBytes("UTF-8");
			...
			tmp[0] = (byte)((c>>24) & 0xff);
			tmp[1] = (byte)(c & 0xff);
			tmp[2] = (byte)((c>>8) & 0xff);
			tmp[3] = (byte)((c>>16) & 0xff);
			reString = toHex(tmp);
